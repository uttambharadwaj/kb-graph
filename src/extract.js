...
- Describe, do not judge. Use a neutral predicate unless the text itself states the judgment: points_at, configured_to, depends_on — not misconfigured_to, broken_by, violates. A qualifier like "temporary, tracked by PF-3043 for revert" makes something a deliberate choice, so an evaluative predicate would assert the opposite of what the text says.
...
Example
Input: "Production Metronome points at sandbox Metronome, which is temporary and tracked by PF-3043 for revert. Kris owns an 8-PR stack moving wallet identity onto the users row; all eight are still open."
Output: {"facts":[{"subject":"production_metronome","predicate":"deliberately_points_at","object":"sandbox_metronome","category":"architecture"},{"subject":"pf-3043","predicate":"tracks_revert_of","object":"production_metronome_sandbox_pointing","category":"status"},{"subject":"kris","predicate":"owns","object":"wallet_identity_pr_stack","category":"ownership"},{"subject":"wallet_identity","predicate":"migration_proposed_in","object":"wallet_identity_pr_stack","category":"decision"}],"skipped":[]}`;
